        ...
        <div style={{ padding: "14px 18px 16px", borderBottom: `1px solid #ffffff07` }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              ...
              fontFamily: "'Cormorant Garamond',serif", fontSize: 20, fontWeight: 700, color: "#000", flexShrink: 0,
          ...
          {NAV.map(({ id, icon, label }) => {
            ...
            return (
              <button key={id} onClick={() => navigate(id)} style={{
                ...
                {badge > 0 && (
                  <span style={{ background: C.ember, borderRadius: 10, padding: "1px 7px", fontSize: 10, color: "#fff", fontFamily: "'Inter',sans-serif", fontWeight: 700, animation: "fadeIn .3s ease" }}>{badge}</span>
                )}
              </button>
            );
          })}
      ...
      <main style={{ marginLeft: 218, flex: 1, display: "flex", flexDirection: "column", minHeight: "100vh" }}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <div style={{ width: 6, height: 6, borderRadius: "50%", background: C.lime, boxShadow: `0 0 6px ${C.lime}`, animation: "fadeIn 1s ease infinite alternate" }} />
          ...
          {submittedCount > 0 && (
            <button onClick={() => navigate("submissions")} style={{ padding: "4px 12px", background: `${C.ember}22`, border: `1px solid ${C.ember}55`, borderRadius: 5, color: C.ember, fontSize: 11, fontFamily: "'Barlow Condensed',sans-serif", letterSpacing: "0.1em", cursor: "pointer", animation: "fadeIn .3s ease" }}>
